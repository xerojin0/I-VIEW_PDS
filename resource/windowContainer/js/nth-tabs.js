...
(function ($) {
    ...
    $.fn.nthTabs = function (options) {
        ...
        var template =
            '<div class="page-tabs">' +
            '<a href="#" class="roll-nav roll-nav-left"><span class="fas fa-chevron-left"></span></a>' +
            '<div class="content-tabs">' +
            '<div class="content-tabs-container">' +
            '<ul class="nav nav-tabs"></ul>' +
            '</div>' +
            '</div>' +
            '<a href="#" class="roll-nav roll-nav-right"><span class="fas fa-chevron-right"></span></a>' +
            '<div class="dropdown roll-nav right-nav-list">' +
            '<a href="#" class="dropdown-toggle" data-toggle="dropdown">' +
            '<span class="tab-down"></span></a>' +
            '<ul class="dropdown-menu">' +
            '<li><a href="#" class="tab-location">현재 탭 찾기</a></li>' +
            '<li><a href="#" class="tab-close-current">현재 탭 닫기</a></li>' +
            '<li role="separator" class="divider"></li>' +
            '<li><a href="#" class="tab-close-other">다른 탭 닫기</a></li>' +
