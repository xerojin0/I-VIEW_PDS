...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        options: {
            ...
            defaultLinkColor: '#c1c8cd',
            defaultSelectedLinkColor: '#217CE8',
            linkWidth: 2,
            grid: 20,
        ...
        _create: function () {
            ...
            shape.setAttribute("stroke", "#217CE8");
        ...
        _initEvents: function () {
            ...
            this.objs.layers.operators.on('click', '.flowchart-operator-connector-label', function (e) {
                $('.flowchart-operator-connector-label').removeClass('selectedlabel');
                $(this).addClass('selectedlabel');
                self.selectOperatorLabel($(this).parents('.flowchart-operator').data('operator_id'), $(this).data('labelkey'));
            });

            this.objs.layers.operators.on('click', '.flowchart-operator-connector-arrow', function () {
                var $this = $(this).parents('.flowchart-operator-connector');
        ...
        _clearLinksLayer: function () {
            ...
            this.objs.layers.operators.find('.flowchart-operator-connector-small-arrow').css('border-left-color', 'none');
        },
        ...
        _getOperatorFullElement: function (operatorData) {
            ...
            $operator_title.addClass(infos.nodetype);
        ...
        _createSubConnector: function (connectorKey, connectorInfos, fullElement) {
            ...
            $operator_connector_label.data('labelkey', connectorKey);
        ...
        selectOperatorLabel: function (operatorId, labelKey) {
            if (!this.callbackEvent('operatorSelectLabel', [operatorId, labelKey])) {
                return;
            }
            this.unselectLink();
            this._removeSelectedClassOperators();
...
/*            linkData.internal.els.fromSmallConnector.css('border-left-color', color);
        ...
        getOperatorLabel: function (operatorId, labelkey) {
          if (this.data.operators[operatorId].internal.properties.nodetype != "node_end") {
            return eval('this.data.operators[operatorId].internal.properties.outputs.' + labelkey).label;
          } else {
            return eval('this.data.operators[operatorId].internal.properties.inputs.' + labelkey).label;
          }
        },

        getOperatorLabelSelectOprId: function () {
            return this.selectedOperatorId;
        },

        getOperatorLabelSelectLblKey: function () {
            return this.selectedLabelKey;
        },
